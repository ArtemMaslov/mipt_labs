...
\begin{document}
	...
	\begin{center}
		\large
		\textsc{Лабораторная работа №4.4.3}
		
		\LARGE
		\textbf{Определение сорта стекла и спектральных характеристик призмы с помощью гониометра}
		\\[5mm]
	...
	\input{Экспериментальная установка.tex}

	\input{Оборудование.tex}
	
	\input{Результаты измерений.tex}
